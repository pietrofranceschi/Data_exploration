...
I now use the qq-plot to check if the distribution of my data is compatible with the normal. This graphical approach allows you
to plot the sample quantiles against the one of a normal distribution. In presence of perfect agreement, the points should stay on the theoretical line
